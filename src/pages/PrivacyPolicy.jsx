        ...
        <div className="min-h-screen bg-stone-900 text-stone-200 font-sans selection:bg-brand-accent/30 selection:text-brand-accent">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 py-12 md:py-20">
                ...
                <header className="mb-12 border-b border-white/10 pb-8">
                    <Link to="/jania-agent" className="inline-flex items-center gap-2 text-stone-400 hover:text-white mb-6 transition-colors">
                ...
                {/* Footer */}
                <footer className="mt-16 pt-8 border-t border-white/10 text-center text-stone-500 text-xs">
