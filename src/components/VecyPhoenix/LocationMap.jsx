        ...
        <section id="location" className="glass-panel bg-white/5 border-white/10 p-6 md:p-12 relative overflow-hidden mt-12">
            ...
            <div className="text-center mb-10 relative z-10">
                ...
                <p className="text-stone-400 text-lg max-w-2xl mx-auto leading-relaxed text-shadow-black">
                    Ubicado en una zona de alta valorización, con fácil acceso a vías principales, centros comerciales y parques.
                </p>
            </div>
            ...
            <div className="relative w-full h-[400px] md:h-[500px] rounded-3xl overflow-hidden border-2 border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.3)] group">
                ...
                <iframe
                    title="Ubicación Portales del Norte II"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3976.386762693892!2d-74.0535!3d4.7455!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNMKwNDQnNDMuOCJOIDc0wrAwMycxMi42Ilc!5e0!3m2!1ses!2sco!4v1636582456000!5m2!1ses!2sco&q=Carrera+65+%23+167+-+18,+Bogotá"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen=""
