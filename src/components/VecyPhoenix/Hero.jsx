        ...
        <header id="hero" className="relative pt-8 pb-12 px-4">
            <div className="max-w-6xl mx-auto glass-panel bg-gradient-to-br from-white/10 via-white/5 to-transparent border-white/10 p-8 md:p-16 text-center relative overflow-hidden backdrop-blur-3xl shadow-2xl">
                ...
                <div className="mt-8 relative z-20">
                    <Link to="/" className="inline-flex items-center gap-3 px-8 py-4 bg-brand-accent text-black font-bold text-lg rounded-full shadow-[0_0_20px_rgba(217,119,6,0.4)] hover:shadow-[0_0_30px_rgba(217,119,6,0.6)] hover:scale-105 transition-all duration-300 group font-inter">
